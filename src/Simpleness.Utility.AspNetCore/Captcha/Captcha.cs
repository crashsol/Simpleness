...
namespace Simpleness.Infrastructure.AspNetCore.Captcha
{
    ...
    public class Captcha
    {
        ...
        /// 检验验证码是否正确
        /// </summary>
        /// <param name="userInputCaptcha">用户输入</param>
        /// <param name="httpContext"></param>
        /// <returns></returns>
        public static bool ValidateCaptchaCode(string userInputCaptcha, HttpContext httpContext)
        {

            var isValidate = string.Equals(userInputCaptcha, httpContext.Session.GetString("CaptchaCode"), StringComparison.OrdinalIgnoreCase);
